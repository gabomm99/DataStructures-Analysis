...
public class A1Example {
	 ...
	 * 
	 * Output: integer sum of values in values
	 * 
	 * Preconditions:
	 * Input array must not be null.
	 */
	
	static int calculateValueSum(int[] values) {
	...
	static int findValueMin(int[] values) {
		
		// Initialize current minimum to first value in array.
		int cur_min = values[0];
	...
	static int findValueMax(int[] values) {
